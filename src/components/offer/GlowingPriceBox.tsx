    ...
    <div className="relative group">
      ...
      <div className="relative bg-gray-900/90 backdrop-blur-xl p-8 rounded-2xl border border-blue-500/50
        ...
        <div className="text-center">
          <h3 className="text-3xl font-bold text-white mb-4">{pricing.box.title}</h3>
          <p className="text-xl text-blue-300 mb-6">{pricing.box.subtitle}</p>
          <div className="flex items-baseline justify-center gap-2 mb-8">
            <span className="text-5xl font-bold text-white">{pricing.box.price}</span>
            <span className="text-gray-400">{pricing.box.period}</span>
          </div>
